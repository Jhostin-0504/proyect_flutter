...
class _ListViewBuilderScreenState extends State<ListViewBuilderScreen> {
  ...
  Future fechData() async {
    ...
    scrollController.animateTo(scrollController.position.pixels + 10,
          ...
          children: [
            RefreshIndicator(
              ...
              child: ListView.builder(
                physics:
                    const BouncingScrollPhysics(), //efecto para scroll en blanco al terminar la imagen
